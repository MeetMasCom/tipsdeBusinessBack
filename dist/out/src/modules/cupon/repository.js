...
class CuponRepository {
    save(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const spamModel = yield (0, model_1.cuponModelMongo)(cnxMongo);
    ...
    getUserSpam(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const cnxMongo = yield (0, conection_1.connectionMongo)();
                const spamModel = yield (0, model_1.cuponModelMongo)(cnxMongo);
                const response = yield spamModel.find({ user_id: id })
                    .sort({ created_at: -1 })
                    .exec();
                yield cnxMongo.close();
                return response;
    ...
    updateState(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const cnxMongo = yield (0, conection_1.connectionMongo)();
                const adminModel = yield (0, model_1.cuponModelMongo)(cnxMongo);
    ...
    getCuponActivoUser(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const objectId = new mongoose_1.Types.ObjectId(id);
                const cnxMongo = yield (0, conection_1.connectionMongo)();
                const spamModel = yield (0, model_1.cuponModelMongo)(cnxMongo);
                const response = yield spamModel.find({
                    user_id: id,
                    state: 0
                })
                    .exec();
    ...
    getByCodigo(codigo) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log(codigo);
                const cnxMongo = yield (0, conection_1.connectionMongo)();
                const cuponModel = yield (0, model_1.cuponModelMongo)(cnxMongo);
                const response = yield cuponModel.find({
                    codigo: codigo,
                })
                    .sort({ created_at: -1 })
                    .exec();
