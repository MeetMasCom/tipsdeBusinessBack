...
var EmailHelper = /** @class */ (function () {
    function EmailHelper() {
        ...
        this.nodemailerConfig = {
            host: environment_1.HOST_EMAIL,
            port: Number(environment_1.PORT_EMAIL),
            secure: true,
            auth: {
                user: environment_1.USER_EMAIL,
                pass: environment_1.PASS_EMAIL,
            },
        };
    ...
    EmailHelper.prototype.sendEmailTemplate = function (titulo, attachments, templateName, contexts) {
        ...
        return new Promise(function (resolve, reject) {
            var mailOpciones = {
                from: environment_1.EMISOR_EMAIL,
                to: contexts.email,
                subject: titulo,
