...
var wrapperError = function (err, _req, res, _next) { return __awaiter(void 0, void 0, void 0, function () {
    var objServiceResponse, message, objServiceResponse;
    return __generator(this, function (_a) {
        if (["ForbiddenException", "HttpException", "AuthenticationException"].includes(err.constructor.name)) {
            ...
            return [2 /*return*/, (0, responseHelper_1.serviceResponse)(objServiceResponse)];
        }
        else if (err instanceof express_validation_1.ValidationError) {
            message = Object.values(err.details)
                .reduce(function (a, v) {
                a.push.apply(a, v.map(function (i) { return i.message; }));
                return a;
            }, [])
                .join(" ");
            objServiceResponse = {
