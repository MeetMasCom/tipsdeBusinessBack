...
var AdminService = /** @class */ (function () {
    function AdminService() {
        ...
        this.login = function (params) { return __awaiter(_this, void 0, void 0, function () {
            var jwtHelper, bcryptHelper, stringHelper, emailHelper, findUser, validPassword, userOpt, token, user, error_2;
        ...
        this.validOpt = function (params) { return __awaiter(_this, void 0, void 0, function () {
            var jwtHelper, findUser, opt, timeStampOpt, maxTimeStamp, token, user, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
        ...
        this.getByRol = function (id) { return __awaiter(_this, void 0, void 0, function () {
            var error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.repo.getByRol(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        error_6 = _a.sent();
                        throw new Error(messages_1.ERR_400);
        ...
        this.updateAdmin = function (id, payload) { return __awaiter(_this, void 0, void 0, function () {
            var error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.repo.updateAdmin(id, payload)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        error_8 = _a.sent();
                        throw new Error(messages_1.ERR_400);
