...
var SubPromptSService = /** @class */ (function () {
    function SubPromptSService() {
        var _this = this;
        ...
        this.getSubPromptsById = function (id) { return __awaiter(_this, void 0, void 0, function () {
            var error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.repo.getSubPromptsById(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        error_2 = _a.sent();
