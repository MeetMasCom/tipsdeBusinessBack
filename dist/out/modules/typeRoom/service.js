...
exports.TypeRoomService = void 0;
var messages_1 = require("../../constants/messages");
var repository_1 = require("./repository");
var TypeRoomService = /** @class */ (function () {
    function TypeRoomService() {
        var _this = this;
        ...
        this.getByIdHotel = function (id) { return __awaiter(_this, void 0, void 0, function () {
            var error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.repo.getByIdHotel(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        error_4 = _a.sent();
                        throw new Error(messages_1.ERR_400);
        ...
        this.repo = new repository_1.TypeRoomRepository();
    }
    return TypeRoomService;
}());
exports.TypeRoomService = TypeRoomService;
