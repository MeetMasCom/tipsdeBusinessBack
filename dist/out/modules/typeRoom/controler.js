...
var createTypeRoomController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var payload, typeService, _a, error_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                payload = req.body;
                console.log(payload);
                typeService = new service_1.TypeRoomService();
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, typeService.save(payload)];
...
var getAllTypeController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var typeService, _a, error_2;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, typeService.getAll()];
            case 1: return [2 /*return*/, _a.apply(void 0, [(_b.data = _c.sent(),
                        _b.res = resp,
                        _b.req = req,
                        _b)])];
...
var getByIdController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var id, typeService, _a, error_3;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, typeService.getById(id)];
            case 1: return [2 /*return*/, _a.apply(void 0, [(_b.data = _c.sent(),
                        _b.res = resp,
                        _b.req = req,
                        _b)])];
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, typeService.getByIdHotel(id)];
            case 1: return [2 /*return*/, _a.apply(void 0, [(_b.data = _c.sent(),
                        _b.res = resp,
                        _b.req = req,
                        _b)])];
