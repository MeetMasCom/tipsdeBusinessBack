...
var CatalogueService = /** @class */ (function () {
    function CatalogueService() {
        ...
        this.getByOptions = function (code) { return __awaiter(_this, void 0, void 0, function () {
            var catalogue, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.repo.getByCode(code)];
                    case 1:
                        catalogue = _a.sent();
                        if (!catalogue) {
                            throw new Error(messages_1.ERR_400);
                        }
                        return [4 /*yield*/, this.repo.getByOptions(catalogue._id)];
