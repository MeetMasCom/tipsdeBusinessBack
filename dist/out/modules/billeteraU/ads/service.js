...
var age_enum_1 = require("../../enums/age.enum");
                    ...
                    case 2:
                        ...
                        data.forEach(function (item) {
                            ...
                            (_a = item.age) === null || _a === void 0 ? void 0 : _a.forEach(function (age) {
                                switch (age) {
                                    case age_enum_1.AgeEnum.entre1315:
                                        ...
                                        break;
                                    case age_enum_1.AgeEnum.entre1618:
                                        ...
                                        break;
                                    case age_enum_1.AgeEnum.entre1925:
                                        ...
                                        break;
                                    case age_enum_1.AgeEnum.mayor25:
                                        if (user_1.age > 25) {
                                            valid = true;
                                        }
                                        else {
