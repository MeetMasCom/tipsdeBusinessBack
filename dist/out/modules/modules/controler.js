...
var getModuleByIdCourseController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, userService.getModuleByIdCourse(id)];
            case 1: return [2 /*return*/, _a.apply(void 0, [(_b.data = _c.sent(),
                        _b.res = resp,
                        _b.req = req,
                        _b)])];
...
var getModuleByIdController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, userService.getModuleById(id)];
            case 1: return [2 /*return*/, _a.apply(void 0, [(_b.data = _c.sent(),
                        _b.res = resp,
                        _b.req = req,
                        _b)])];
...
var getModulesAnTopicController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, userService.getModulesAndTopic(id)];
            case 1: return [2 /*return*/, _a.apply(void 0, [(_b.data = _c.sent(),
                        _b.res = resp,
                        _b.req = req,
                        _b)])];
...
//TEST
var createTestController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var newPost, userService, _a, error_5;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, userService.saveTest(newPost)];
            case 1: return [2 /*return*/, _a.apply(void 0, [(_b.data = _c.sent(),
                        _b.res = resp,
                        _b.req = req,
                        _b)])];
...
var getTestByIdController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var id, userService, _a, error_6;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, userService.getTestById(id)];
            case 1: return [2 /*return*/, _a.apply(void 0, [(_b.data = _c.sent(),
                        _b.res = resp,
                        _b.req = req,
                        _b)])];
...
var getTestByIdModuleController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var id, userService, _a, error_7;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, userService.getTestByIdModule(id)];
            case 1: return [2 /*return*/, _a.apply(void 0, [(_b.data = _c.sent(),
                        _b.res = resp,
                        _b.req = req,
                        _b)])];
...
//answer
var createAnswerController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var newPost, userService, _a, error_8;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, userService.saveAnswer(newPost)];
            case 1: return [2 /*return*/, _a.apply(void 0, [(_b.data = _c.sent(),
                        _b.res = resp,
                        _b.req = req,
                        _b)])];
