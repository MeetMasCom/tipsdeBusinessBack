...
var PromptsRepository = /** @class */ (function () {
    function PromptsRepository() {
    }
    PromptsRepository.prototype.save = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        cnxMongo = _a.sent();
                        return [4 /*yield*/, (0, model_1.promptsModelMongo)(cnxMongo)];
                    case 2:
                        likeModel = _a.sent();
    ...
    PromptsRepository.prototype.getMyPrompts = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var objectId, cnxMongo, likeModel, response, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 2:
                        likeModel = _a.sent();
                        return [4 /*yield*/, likeModel.find({ user_id: id })
                                .exec()];
                    case 3:
                        response = _a.sent();
                        return [4 /*yield*/, cnxMongo.close()];
    ...
    PromptsRepository.prototype.getPromptsById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        likeModel = _a.sent();
                        return [4 /*yield*/, likeModel.find({ _id: id })
                                .exec()];
                    case 3:
                        response = _a.sent();
                        return [4 /*yield*/, cnxMongo.close()];
    ...
    PromptsRepository.prototype.getAllPrompts = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    PromptsRepository.prototype.updatePrompt = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
