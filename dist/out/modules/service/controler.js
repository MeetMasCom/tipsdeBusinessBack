...
var createServiceController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var payload, serviceService, _a, error_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 2, , 3]);
                payload = req.body;
                serviceService = new service_1.ServiceService();
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, serviceService.save(payload)];
...
var getAllServiceController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var serviceService, _a, error_2;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, serviceService.getAll()];
            case 1: return [2 /*return*/, _a.apply(void 0, [(_b.data = _c.sent(),
                        _b.res = resp,
                        _b.req = req,
                        _b)])];
...
var getByIdHotelController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var id, serviceService, _a, error_3;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, serviceService.getByIdHotel(id)];
            case 1: return [2 /*return*/, _a.apply(void 0, [(_b.data = _c.sent(),
                        _b.res = resp,
                        _b.req = req,
                        _b)])];
...
var getByIdServiceController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var id, serviceService, _a, error_4;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, serviceService.getByIdService(id)];
            case 1: return [2 /*return*/, _a.apply(void 0, [(_b.data = _c.sent(),
                        _b.res = resp,
                        _b.req = req,
                        _b)])];
