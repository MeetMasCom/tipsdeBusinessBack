...
var getMessaguesController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var userTo, userFrom, chatService, _a, error_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _b = {};
                return [4 /*yield*/, chatService.getMessagues(userTo, userFrom)];
...
var saveMessaguesController = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var chatService, data, _a, error_3;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = responseHelper_1.serviceResponse;
                _b = {};
                return [4 /*yield*/, chatService.saveMessagues(data)];
            case 1: return [2 /*return*/, _a.apply(void 0, [(_b.data = _c.sent(),
                        _b.res = resp,
                        _b.req = req,
                        _b)])];
