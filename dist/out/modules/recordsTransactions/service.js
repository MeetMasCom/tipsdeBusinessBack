...
var RecordsTransactionService = /** @class */ (function () {
    function RecordsTransactionService() {
        var _this = this;
        ...
        this.save = function (payload) { return __awaiter(_this, void 0, void 0, function () {
            var error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.repo.save(payload)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        error_3 = _a.sent();
    ...
    return RecordsTransactionService;
}());
